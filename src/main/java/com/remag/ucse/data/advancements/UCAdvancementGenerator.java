package com.remag.ucse.data.advancements;
...
import static com.remag.ucse.init.UCItems.ABSTRACT_SEED;
import static com.remag.ucse.init.UCItems.ADVENTUS_SEED;
import static com.remag.ucse.init.UCItems.ARTISIA_SEED;
import static com.remag.ucse.init.UCItems.BLESSED_SEED;
import static com.remag.ucse.init.UCItems.CINDERBELLA_SEED;
import static com.remag.ucse.init.UCItems.COBBLONIA_SEED;
import static com.remag.ucse.init.UCItems.COLLIS_SEED;
import static com.remag.ucse.init.UCItems.DEVILSNARE_SEED;
import static com.remag.ucse.init.UCItems.DIRIGIBLE_SEED;
import static com.remag.ucse.init.UCItems.DONUTSTEEL_SEED;
import static com.remag.ucse.init.UCItems.DYEIUS_SEED;
import static com.remag.ucse.init.UCItems.ENDERLILY_SEED;
import static com.remag.ucse.init.UCItems.EULA_SEED;
import static com.remag.ucse.init.UCItems.FEROXIA_SEED;
import static com.remag.ucse.init.UCItems.HEXIS_SEED;
import static com.remag.ucse.init.UCItems.IMPERIA_SEED;
import static com.remag.ucse.init.UCItems.INDUSTRIA_SEED;
import static com.remag.ucse.init.UCItems.INSTABILIS_SEED;
import static com.remag.ucse.init.UCItems.INVISIBILIA_SEED;
import static com.remag.ucse.init.UCItems.KNOWLEDGE_SEED;
import static com.remag.ucse.init.UCItems.LACUSIA_SEED;
import static com.remag.ucse.init.UCItems.MAGNES_SEED;
import static com.remag.ucse.init.UCItems.MALLEATORIS_SEED;
import static com.remag.ucse.init.UCItems.MARYJANE_SEED;
import static com.remag.ucse.init.UCItems.MERLINIA_SEED;
import static com.remag.ucse.init.UCItems.MILLENNIUM_SEED;
import static com.remag.ucse.init.UCItems.MUSICA_SEED;
import static com.remag.ucse.init.UCItems.PETRAMIA_SEED;
import static com.remag.ucse.init.UCItems.PIXELSIUS_SEED;
import static com.remag.ucse.init.UCItems.PRECISION_SEED;
import static com.remag.ucse.init.UCItems.QUARRY_SEED;
import static com.remag.ucse.init.UCItems.STEVE_HEART;
import static com.remag.ucse.init.UCItems.SUCCO_SEED;
import static com.remag.ucse.init.UCItems.TERIYAKI;
import static com.remag.ucse.init.UCItems.WAFFLONIA_SEED;
import static com.remag.ucse.init.UCItems.WEEPINGBELLS_SEED;
...
public class UCAdvancementGenerator implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    private DisplayInfo rootDisplay(ItemLike icon, ResourceLocation background) {
        ...
        return new DisplayInfo(new ItemStack(icon.asItem()),
                Component.translatable("itemGroup.ucse"),
                Component.translatable("ucse.desc"),
...
//                .addCriterion("artisia", onPickup(ARTISIA_SEED.get()))
    ...
    private DisplayInfo simple(ItemLike icon, String name) {
        ...
        String str = "advancement.ucse:" + name;
        return new DisplayInfo(new ItemStack(icon.asItem()),
